...
<form role="form" method="get" id="form1">
	...
	<div id="banner">
		<img width="560px" height="390px"
			src="${contextPath}/Cafedownload.do?fileNO=${list2.PROGRAM_NO}&fileName=${list2.EMP_FILENAME}">
		<div id="cafe">
			<a id="cafename1" href="${contextPath}/cafe/hireInfoDetail.do?PROGRAM_NO=${list2.PROGRAM_NO}">${list2.TITLE}</a><br> <br> 
			<a id="cafecontent"> <a id="cafedate"> <fmt:formatDate
											value="${list2.S_DATE}" pattern="yyyy-MM-dd " />~<fmt:formatDate
											value="${list2.E_DATE}" pattern=" yyyy-MM-dd" /></a> <br> 
				   <hr>   ${list2.CONTENT} 
			</a>
