...
<head>
	...
	var chart = new Chart(ctx, {
		...
		datasets: [{ label: '방문자 수',
		backgroundColor: [ 'rgb(70, 163, 196)', 'rgb(158, 194, 228)', 'rgb(197, 107, 171)', 'rgb(246, 154, 193)',
			'rgb(78, 127, 185)','rgb(177, 168, 213)', 'rgb(241, 103, 139)', 'rgb(243, 181, 170)',
			'rgb(183, 210, 55)','rgb(205, 227, 155)','rgb(247, 149, 110)','rgb(253, 214, 185)',
			'rgb(131, 193, 92)','rgb(159, 213, 189)','rgb(251, 184, 95)','rgb(255, 227, 162)'],
		
		data: [<c:forEach items="${menuList}" var="menu">
		${menu.COUNT},
		</c:forEach>] }] },
